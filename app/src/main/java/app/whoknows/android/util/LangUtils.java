...
public class LangUtils {
    ...
    static String getCurrentAppLang() {
        mCurrentLang = WhoKnows.Companion.getInstance().getAppPref().getString(AppConstants.PREF_KEY_SELECTED_LANG);
    ...
    public static void switchAppLanguage(@LangValue String lang) {
        mCurrentLang = lang;
        WhoKnows.Companion.getInstance().getAppPref().saveString(AppConstants.PREF_KEY_SELECTED_LANG, mCurrentLang);
    }
}
